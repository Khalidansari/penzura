		...
		<div>
			<table>
				...
				<tr>
					...
					<td width="25%" style="padding:40px">
						<img src="companyLogo.png" style="position:relative;left:-6px;top:10px"/>
						<form action="/SignUpServlet" method="post">
							<table style="position:relative; top:30px;width:100%"">
								<tr>
									<td><input style="width:100%" type="text" name="username" id="username" placeholder="someone@something.com"></td>
								</tr>
								<tr>
									<td><input style="width:100%" type="text" name="fullName" placeholder="full name"></td>
								</tr>
								<tr>
									<td ><input stle="width:100%" type="password" name="pw" placeholder="password"></td>
								</tr>
								<tr>
									<td><input style="width:100%" type="submit" value="Sign Up" onclick="return validateForm();"></td>
								</tr>
							</table>
						</form> 
					</td>
